aracyc_dump contains the following data from AraCyc, in a tab delimited format. The columns are:
...
6. EC.				EC number of the reaction which contains this compound either as a reactant or a product. If no EC number, the AraCyc frame name for the reaction is given.
